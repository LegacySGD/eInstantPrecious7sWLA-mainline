...
public class Precious7sWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(Precious7sWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/Precious7sWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/Precious7sWLAIW/InitOutcome.xml").getDocumentElement();
